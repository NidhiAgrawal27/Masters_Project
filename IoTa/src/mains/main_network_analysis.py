...
CONFIG = {
    "crypto": "../logs/generated_files/segregated_iota.gml",
    "figure_dir": "../logs/figures/network_analysis/"
}
...
def main():
    ...
    network_name = nx.read_gml(CONFIG['crypto'])
    ...
    fig9 = visualization.plot_graph1(x = av_neig_deg[0],y = av_neig_deg[1],graph_type='scatter',bin = None,ylabel= y_label,xlabel= x_label,title= title,color= 'blue',ylog= ylog, density=None,edgecolor=None,marker = 'o', linestyle = '',rotation= rotation)
    fig9.savefig(os.path.join(CONFIG["figure_dir"], 'av_neigh_deg.png'), bbox_inches="tight")
    ...
    fig10 = visualization.plot_graph1(x = degree_list,y = None, graph_type = 'hist',bin = max(degree_list), ylabel = y_label,xlabel = x_label, title = title,color = 'blue', ylog = ylog, density=True,edgecolor='white',rotation= rotation, marker = None, linestyle = None)
    fig10.xlim([0,10])
    fig10.savefig(os.path.join(CONFIG["figure_dir"], 'degree_distribution.png'), bbox_inches="tight")
    ...
    fig11 = visualization.plot_graph1(x = centralities[0],y = centralities[1],graph_type='scatter',bin = None,ylabel= y_label,xlabel= x_label,title= title,color= 'red',ylog= ylog, density=None,edgecolor=None,marker = 'o', linestyle = '',rotation= rotation)
    ...
    fig11.legend()
    fig11.savefig(os.path.join(CONFIG["figure_dir"], 'centralities.png'), bbox_inches="tight")
    ...
    fig12.savefig(os.path.join(CONFIG["figure_dir"], 'Greedy_mod_comm.png'), bbox_inches="tight")
    ...
    fig13.savefig(os.path.join(CONFIG["figure_dir"], 'Label_prop_comm.png'), bbox_inches="tight")
