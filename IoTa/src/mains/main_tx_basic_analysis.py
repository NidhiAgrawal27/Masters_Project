...
CONFIG = {
    "data_path": "../logs/generated_files/processed_data.csv",
...
def main():
    ...
    fig1 = visualization.plot_graph(df_tx_count_per_date, 'bar', tx_label, date_label, title, 'cyan', ylog, rotation)
    fig1.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_per_date.png'), bbox_inches="tight")

    # Number of transaction on each date - Line graph
    title = 'Trend of number of transactions on each date'
    fig2 = visualization.plot_graph(df_tx_count_per_date, 'line', tx_label, date_label, title, 'cyan', ylog, rotation)
    fig2.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_per_date_trend.png'), bbox_inches="tight")
    ...
    fig3 = visualization.plot_graph(df_ip_addrs_more_than_1_count_per_date, 'bar', tx_label, date_label, title, 'blue', ylog, rotation)
    fig3.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_ip_adrs.png'), bbox_inches="tight")
    ...
    fig4 = visualization.plot_graph(df_ip_addrs_equalto_1_count_per_date, 'bar', tx_label, date_label, title, 'blue', ylog, rotation)
    fig4.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_ip_adrs_equal1.png'), bbox_inches="tight")
    ...
    fig5 = visualization.plot_graph(df_op_addrs_more_than_1_count_per_date, 'bar', tx_label, date_label, title, 'red', ylog, rotation)
    fig5.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_op_adrs.png'), bbox_inches="tight")
    ...
    fig6 = visualization.plot_graph(df_op_addrs_equalto_1_count_per_date, 'bar', tx_label, date_label, title, 'red', ylog, rotation)
    fig6.savefig(os.path.join(CONFIG["figure_dir"], 'num_tx_op_adrs_equal1.png'), bbox_inches="tight")
    ...
    ylog = 1
    rotation = 0
    fig7 = visualization.plot_graph(df['num_input_addresses'].value_counts(), 'bar', tx_label, ip_adrs_label, title, 'blue', ylog, rotation)
    fig7.savefig(os.path.join(CONFIG["figure_dir"], 'ip_addrs_dist.png'), bbox_inches="tight")
    ...
    fig8 = visualization.plot_graph(df['num_output_addresses'].value_counts(), 'bar', tx_label, op_adrs_label, title, 'red', ylog, rotation)
    fig8.savefig(os.path.join(CONFIG["figure_dir"], 'op_addrs_dist.png'), bbox_inches="tight")
