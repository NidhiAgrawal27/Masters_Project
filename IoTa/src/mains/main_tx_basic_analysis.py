...
def main():
    ...
    df = pd.read_csv(CONFIG['processed_data'], parse_dates=['datetime'])
    ...
    pathlib.Path(CONFIG["tx_basic_analysis_fig_dir"]).mkdir(parents=True, exist_ok=True)
    ...
    fig1.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_per_date.png'), bbox_inches="tight")
    ...
    fig2.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_per_date_trend.png'), bbox_inches="tight")
    ...
    fig3.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_ip_adrs.png'), bbox_inches="tight")
    ...
    fig4.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_ip_adrs_equal1.png'), bbox_inches="tight")
    ...
    fig5.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_op_adrs.png'), bbox_inches="tight")
    ...
    fig6.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'num_tx_op_adrs_equal1.png'), bbox_inches="tight")
    ...
    fig7.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'ip_addrs_dist.png'), bbox_inches="tight")
    ...
    fig8.savefig(os.path.join(CONFIG["tx_basic_analysis_fig_dir"], 'op_addrs_dist.png'), bbox_inches="tight")
