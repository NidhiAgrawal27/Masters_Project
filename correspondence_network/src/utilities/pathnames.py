...
def pathnames(cur, heuristic, weighted):
    ...
    elif cur == 'iota':           data_path = server_data_dir + 'iota_tx_data/IOTA_1year_tx_data.csv'
    elif cur == 'btc_2012':       data_path = btc_server_dir + 'BTC_TXS_2012.csv'
    elif cur == 'btc_2013':       data_path = btc_server_dir + 'BTC_TXS_2013.csv'
    elif cur == 'btc_2014':       data_path = btc_server_dir + 'BTC_TXS_2014.csv'
    elif cur == 'btc':            data_path = server_data_dir + 'btc_trx/BTC_TXS.csv'
