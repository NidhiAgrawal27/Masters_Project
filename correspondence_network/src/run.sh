...
for seed in {42..42}
    do
        ...
        python -m mains.main_split_correspondence_ntwrk --seed $seed --currency iota --heuristic h0 --vis yes --chunksize 5000
        python -m mains.main_split_correspondence_ntwrk --seed $seed --currency iota --heuristic h0+h1 --vis yes --chunksize 5000
        python -m mains.main_network_analysis --seed $seed --currency iota --heuristic h0
        python -m mains.main_network_analysis --seed $seed --currency iota --heuristic h0+h1
