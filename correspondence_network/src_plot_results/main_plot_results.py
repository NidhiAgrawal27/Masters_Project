...
def main(load_dir, save_dir, currencies, weighted, modularity_file):
    ...
    for cur in currencies:
        ...
        for wt in weighted:
            ...
            plot_edges_gaussian(df_components_h0['component_size'], df_components_h0['num_of_edges'], cur, wt, 'Connected Component Size', 'Number of Edges', save_fig_dir_h0 + 'comp_size_edges.png')
            plot_edges_gaussian(df_components_h0_h1['component_size'], df_components_h0_h1['num_of_edges'], cur, wt, 'Connected Component Size', 'Number of Edges', save_fig_dir_h0_h1 + 'comp_size_edges.png')
